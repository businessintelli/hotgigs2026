  ...
  return (
    <div className="p-4 md:p-6 space-y-6 pb-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Interviews</h1>
          <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Schedule and manage candidate interviews</p>
        </div>
      </div>
      <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-12 text-center">
        ...
        <p className="text-neutral-500 dark:text-neutral-400 max-w-md mx-auto">
          Schedule, track, and manage candidate interviews. This module is available in the full Docker deployment.
        </p>
      </div>
    </div>
  );
